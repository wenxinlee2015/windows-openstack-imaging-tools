...
$windowsImagePath = "F:\windows-server-2019\qcow2-files-50g\windows-server-2019-image.qcow2"

# The wim file path is the installation image on the Windows ISO
$wimFilePath = "F:\windows-server-2019\iso-files\winsever2019.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_en-us\sources\install.wim"

# VirtIO ISO contains all the synthetic drivers for the KVM hypervisor
$virtIOISOPath = "F:\windows-server-2019\virtio-iso\virtio-win-0.1.185.iso"
...
$extraDriversPath = "F:\windows-server-2019\drivers-iso"
...
Set-IniFileValue -Path $configFilePath -Section "vm" -Key "disk_size" -Value (50GB)
